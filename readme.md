Claro! Aqui está o README corrigido, separando claramente os comandos das instruções textuais, com blocos de código apenas para comandos e configurações, e texto explicativo fora dos blocos.
